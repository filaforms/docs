...
Forms can be shared via public URLs so respondents can submit without needing an admin account.
...
Submission limits control how many responses a form accepts:
